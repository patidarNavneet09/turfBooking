...
import 'package:truckmanagement/Screens/privacy_policy.dart';
...
class _SettingState extends State<Setting> {
                    ...
                    Container(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(
                            top: 25, bottom: 25, right: 2),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            SizedBox(
                              width: screen.size.width * 0.03,
                            ),
                            ClipOval(
                              child: CachedNetworkImage(
                                imageUrl:
                                    profilegetResponse.data!.image.toString(),
                                ...
                                fit: BoxFit.cover,
                                height: screen.size.height * 0.08,
                                width: screen.size.height * 0.08,
                              ),
                            ),
                            // SizedBox(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      profilegetResponse.data!.email.toString(),
                                      style: const TextStyle(
                                        fontSize: 13,
                                        color: MyColor.white,
                                        fontFamily:
  ...
  Widget buildCard(MediaQueryData screen, String title, String imagePath) {
    return Card(
      elevation: 1,
      child: ListTile(
        leading: Image.asset(
