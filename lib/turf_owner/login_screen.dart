...
import 'package:turfbooking/turf_owner/otp_screen.dart';
                ...
                Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Image.asset(
                          "assets/images/Welcome Turf Owner.png",
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Text.rich(TextSpan(
                                    text:
                                        MyString.bycontinuingyouagreetoour.tr(),
                                    style: const TextStyle(
                                      fontSize: 12,
                                      color: Colors.black,
                                      //    fontFamily: ColorFamily.fontsPopinsDisplay,
                        ...
                        onPressed: () {
                          if (isChecked == true) {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => const OtpOwner()));
                          } else {
                            Utility.getToast(
